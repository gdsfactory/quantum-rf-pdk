...
If you prefer, you may contact the maintainers directly via the email addresses listed in the project's [PyPI page](https://pypi.org/p/qpdk) or in `pyproject.toml`.
...
- We will coordinate a fix and release timeline with you and credit you in the release notes (unless you prefer to remain anonymous).
