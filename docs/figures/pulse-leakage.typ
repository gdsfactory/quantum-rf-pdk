...
#cetz.canvas(length: 1cm, {
  ...
  content(
    (0.5, 5.03),
    text(size: 8pt, weight: "bold", fill: blue, [PULSE CONTROL AND LEAKAGE]),
    anchor: "west",
  )
  content(
    (0.5, 4.59),
  ...
  content(
    (3.7, 3.8),
    text(size: 10pt, weight: "bold", fill: blue, [microwave pulse]),
    anchor: "center",
  )
  ...
  content(
    (11.5, 3.86),
    text(size: 10pt, weight: "bold", fill: blue, [transmon levels]),
    anchor: "center",
  )
  ...
  content(
    (13.55, 1.25),
    text(size: 9pt, weight: "bold", [$|0⟩$]),
    anchor: "west",
  )
  content(
    (13.55, 2.53),
    text(size: 9pt, weight: "bold", [$|1⟩$]),
    anchor: "west",
  )
  content(
    (13.55, 3.47),
    text(size: 9pt, weight: "bold", [$|2⟩$]),
    anchor: "west",
  )
  ...
  line((12.25, 2.67), (12.25, 3.29), stroke: 1.6pt + coral, mark: (
    end: ">",
    size: 0.16,
    fill: coral,
  ))
  ...
  content(
    (12.25, 0.72),
    text(size: 8pt, fill: coral, [leakage]),
    anchor: "center",
  )
})
