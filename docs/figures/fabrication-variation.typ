...
#cetz.canvas(length: 1cm, {
  ...
  content(
    ...
    text(
      size: 8pt,
      fill: muted,
      [Each tick is a resonant frequency; the arrows show changes from one fabrication draw.],
    ),
    anchor: "west",
  )
  ...
  content(
    (14.75, 2.6),
    text(size: 7pt, fill: blue, [shared shift]),
    anchor: "east",
  )
  ...
  content(
    (14.8, 0.58),
    text(size: 8pt, fill: muted, [frequency]),
    anchor: "east",
  )
})
