...
class TestTransductionEfficiency:
    ...
    @staticmethod
    def test_impedance_matched() -> None:
    ...
    @staticmethod
    def test_zero_cooperativity() -> None:
    ...
    @staticmethod
    def test_high_cooperativity() -> None:
    ...
    def test_efficiency_bounded_hypothesis(
        cooperativity: float, eta_mw: float, eta_opt: float
    ) -> None:
...
class TestTransducerCooperativity:
    ...
    @staticmethod
    def test_scaling_with_coupling() -> None:
...
class TestTransducerAddedNoise:
    ...
    @staticmethod
    def test_monotonic_with_thermal() -> None:
...
class TestTransductionBandwidth:
    ...
    @staticmethod
    def test_broadens_with_cooperativity() -> None:
