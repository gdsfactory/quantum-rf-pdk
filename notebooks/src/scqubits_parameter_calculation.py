...
eigenvals_f = fluxonium.eigenvals(evals_count=6)
eigenvals_f -= eigenvals_f[0]
...
# to visualize how anharmonicity varies across the design space.
...
# 3. **Layout**: Map $L_s$ to `inductor_n_turns` in the qpdk `fluxonium` cell.
#
...
# %% [markdown]
# The superinductance $L_s$ — tens of nH for the parameters above, and larger
# still for the low-$E_L$ designs swept in Part III — is realized by a
